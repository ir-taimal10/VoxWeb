var  vxHomeModule = angular.module('vxHomeModule');
var VxHomeController = ['$i18n', function ($i18n) {
    /**
...
vxHomeModule.component('vxHome', {
    transclude: true,
    bindings: {
        title: '@'
    },
    controller: VxHomeController,
    controllerAs: 'ctrl',
    template: require('./vxHome.html')
});
...
$(function(){
    ...
    function transformCard(card, size) {
        return card.style.transform = 'translate(' + size.left + 'px,' + size.top + 'px)' + ' scale(' + size.width + ',' + size.height + ')';
    }
    ...
    function scaleCard(e) {
        ...
        target.style.transitionProperty = addDashes('transform');
