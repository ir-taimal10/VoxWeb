...
var workers = require('./Services/helpers/workers');
var fs = require('fs');
...
if (cluster.isMaster) {
    ...
    app.use(require('./Services/controllers/userController'));
    app.use(require('./Services/controllers/announcementController'));
    app.use(require('./Services/controllers/voiceController'));
    app.use(require('./Services/controllers/dbUtilController'));

    var pathFiles = path.join(__dirname, 'WebContent', 'dist');
